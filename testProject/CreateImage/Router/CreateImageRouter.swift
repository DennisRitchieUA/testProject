...
class UserRegistrationRouter: UserRegistrationRouterInput {
    ...
    let kMainNavigationControllerIdentifier = "MainVC"
    ...
    func presentMainVC() {
        viewController.navigationController?.viewControllers = [(viewController.storyboard?.instantiateViewController(withIdentifier: kMainNavigationControllerIdentifier))!]
    }
}
